      ...
      <div className="max-w-[1400px] mx-auto w-full px-6 sm:px-12 lg:px-20 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        >
          ...
          <div className="space-y-1 mb-6">
            <h1 className="font-serif text-[48px] sm:text-[60px] lg:text-[72px] leading-[1.05] text-[#2F2924]">
              Purely Natural. <br />
        ...
        <div className="lg:col-span-6 relative h-[600px] flex justify-center items-center pointer-events-none mt-10 lg:mt-0">
          ...
          {/* Main Sterile Interactive Wrapper */}
          <div className="relative w-full h-full">
            ...
            >
              <div className="w-full h-full rounded-full overflow-hidden relative shadow-inner bg-[#EFECE5]">
                ...
                <button 
                  onClick={prevImage}
                  className="absolute left-3 top-1/2 -translate-y-1/2 bg-white/60 backdrop-blur-sm text-[#2F2924] p-2 rounded-full opacity-0 group-hover:opacity-100 transition-all hover:bg-white hover:scale-110 z-20 pointer-events-auto"
                >
                ...
                <button 
                  onClick={nextImage}
                  className="absolute right-3 top-1/2 -translate-y-1/2 bg-white/60 backdrop-blur-sm text-[#2F2924] p-2 rounded-full opacity-0 group-hover:opacity-100 transition-all hover:bg-white hover:scale-110 z-20 pointer-events-auto"
                >
            ...
            <div
              className="absolute bottom-[5%] right-[15%] bg-[#F0EBE0]/90 backdrop-blur-md rounded-2xl p-5 shadow-xl border border-white z-20 text-center w-[160px] pointer-events-auto transition-transform hover:scale-105"
            >
